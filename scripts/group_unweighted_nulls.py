...
META_CSV  = Path("results/metrics_merged.csv")#fILE_ID, DX_GROUP, AGE_AT_SCAN, func_mean_fd
OUT_CSV   = Path("results/unweighted_subject_nulls.csv")
...
def lcc(G: nx.Graph) -> nx.Graph:
    """Largest connected component (copy)."""
