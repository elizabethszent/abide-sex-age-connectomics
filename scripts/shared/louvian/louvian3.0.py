...
BASE = Path(r"C:\Users\eliza\Connectomics\TERMproject\abide-sex-age-connectomics")


ALL_MEAN = BASE / r"results\group_connectomes\ABIDE12_CC200\OVERALL_ageSexMatched_fd-0.2_mean_r.npy"

#ALL_IDS  = BASE / r"results\group_connectomes\ALL_SUBJECTS_file_ids.csv"
ALL_IDS  = BASE / r"results\group_connectomes\ABIDE12_CC200\OVERALL_ageSexMatched_fd-0.2_selected_subjects.csv"
