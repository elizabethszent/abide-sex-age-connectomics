...
META = Path("results/metrics_merged.csv")  # has FILE_ID (+ DX_GROUP etc.)
OUT = Path("results/unweighted_path_subjects.csv")
...
def aspl_lcc(G: nx.Graph) -> float:
    """Average shortest path on the largest connected component (unweighted)."""
