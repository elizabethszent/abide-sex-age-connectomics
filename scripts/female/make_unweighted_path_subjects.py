...
META_CSV = Path(r"C:\Users\eliza\CPSC_599_CONNECTOMICS\TERMProject\data\female\processed\female_metadata_included.csv")

OUT_CSV = Path(r"C:\Users\eliza\CPSC_599_CONNECTOMICS\TERMProject\data\female\unweighted_path_subjects.csv")
