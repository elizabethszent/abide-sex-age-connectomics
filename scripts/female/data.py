...
meta = pd.read_csv('data/female/metrics_merged.csv')
...
head.to_csv('results/female/ts_head_for_slide.csv', index=False)
...
plt.tight_layout()
plt.savefig('results/female/figs/connectome_heatmap.png', dpi=200)
plt.close()

print('Wrote: results/female/ts_head_for_slide.csv and results/female/figs/connectome_heatmap.png')
