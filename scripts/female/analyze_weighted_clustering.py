...
W = pd.read_csv("C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/data/female/weighted_clustering_subjects.csv") 
M = pd.read_csv("C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/data/female/female_metadata_included.csv")   
