...
P = pd.read_csv("results/unweighted_path_subjects.csv")   # expects FILE_ID, L_emp, (maybe group)

#load phenotype/meta to get DX_GROUP, AGE_AT_SCAN, motion
M = pd.read_csv("results/metrics_merged.csv")
...
plt.tight_layout()
plt.savefig("results/unweighted_path_groups.png", dpi=200)
plt.close()
print("\nSaved figure -> results/unweighted_path_groups.png")
