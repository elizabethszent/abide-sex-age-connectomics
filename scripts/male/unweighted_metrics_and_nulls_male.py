...
if __name__ == "__main__":
    ...
    plt.tight_layout()
    plt.savefig(f"C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/results/male/figs/unweighted_clustering_nulls_{fid}.png", dpi=200)
    ...
    plt.legend(loc="upper right")
    plt.tight_layout()
    plt.savefig(f"C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/results/male/figs/unweighted_path_nulls_{fid}.png", dpi=200)
    ...
    out.to_csv(f"C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/data/male/unweighted_metrics_{fid}.csv", index=False)
