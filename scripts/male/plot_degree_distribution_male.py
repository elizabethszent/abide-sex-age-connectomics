...
deg_files = sorted(glob.glob("C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/results/male/degrees/*.csv"))
if not deg_files:
...
plt.tight_layout()
plt.savefig("C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/results/male/figs/male_degree_distribution_groups.png", dpi=200)
plt.show()
