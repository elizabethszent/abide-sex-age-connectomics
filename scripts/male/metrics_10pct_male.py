...
IN_IDS = Path("C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/data/male/male_subjects_included.txt")
...
pd.DataFrame(rows).to_csv(OUT / "male_subject_metrics_10pct.csv", index=False)
print("Saved:", OUT / "male_subject_metrics_10pct.csv")
