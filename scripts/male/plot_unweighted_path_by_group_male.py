...
P = pd.read_csv("C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/data/male/unweighted_path_subjects_male.csv")   # expects FILE_ID, L_emp, (maybe group)

#load phenotype/meta to get DX_GROUP, AGE_AT_SCAN, motion
M = pd.read_csv("C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/data/male/male_metrics_merged.csv")
...
plt.tight_layout()
plt.savefig("C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/results/male/figs/male_unweighted_path_groups.png", dpi=200)
plt.close()
print("\nSaved figure -> C:/Users/eliza/CPSC_599_CONNECTOMICS/TERMProject/results/male/figs/male_unweighted_path_groups.png")
